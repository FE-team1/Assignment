...
function State2() {
  ...
  // 새로운 댓글의 초기값을 위해 newComments라는 객체를 설정, 상태값 업데이트를 위해서 usestate를 사용
  const [newComments, setnewComments] = useState({
    nickname : "",
    content : "",
  });

   // 작성자 input 값 변경(입력)시 실행, newComments의 나머지 값은 유지, nickname만 입력값으로 변경
  ...
  // 작성 댓글 input 값 변경(입력)시 실행, newComments의 나머지 값은 유지, content만 입력값으로 변경
